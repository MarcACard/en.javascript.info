...
1. A "producing code" does something and takes time. For instance, the code loads a remote script. That's a "singer".
2. A "consuming code" wants the result of the "producing code" once it's ready. Many functions  may need that result. These are the "fans".
